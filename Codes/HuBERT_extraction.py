...
# Paths
input_path = "input_path_to_audio_sampl"
output_path = "/output_path_to_save_the_represntationsh"
excel_file_path = os.path.join(output_path, "audio_filenames_for_HuBERT.xlsx")
output_npy_path = os.path.join(output_path, "HuBERT_hidden_states.npy")
...
for idx, file_name in enumerate(all_files[0:844], start=0): #choose how many files you want to be processed 
...
print(f"✅ HuBERT feature extraction complete! Output saved to:\n- {output_npy_path}\n- {excel_file_path}")
